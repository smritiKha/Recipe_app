...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    public void displayData(final Recipe post) {
        ...
        btnFontSize.setOnClickListener(view -> {
            ...
            MaterialAlertDialogBuilder dialog = new MaterialAlertDialogBuilder(ActivityNotificationDetail.this);
    ...
    private void loadViewed() {
        if (Tools.isConnect(this)) {
            new MyTask().execute(sharedPref.getApiUrl() + "/api/api.php?get_total_views&id=" + recipeId);
        }
    }
